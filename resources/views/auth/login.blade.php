...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center font-sans transition-colors duration-500">
    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl w-full max-w-md animate-fade-in">
        <h2 class="text-3xl font-bold text-center text-gray-800 dark:text-white mb-6">🎓 Student Login</h2>
        ...
        <form action="{{ route('student.login.post') }}" method="POST" class="space-y-4">
            @csrf
            <div>
                <label class="block mb-1 font-medium text-gray-700 dark:text-gray-300">📞 Phone (Student or Parent):</label>
